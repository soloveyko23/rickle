(() => {
    ...
    (() => {
        ...
        const showSliders = () => {
            const button = document.querySelector(".hero__controller-button");
            const sliders = document.querySelector(".info-block");
            const image = document.querySelector(".billboard-image");
            if (!button) return;
            button.addEventListener("click", (() => {
                document.querySelector(".hero__controller").classList.toggle("no-active");
                image.remove();
